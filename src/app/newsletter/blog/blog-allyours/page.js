...
Back</p></Link>
        <article className="e p-6 ">
          ...
          <section className="text-justify text-gray-700 leading-relaxed">
            <p className="mb-4 ">{blogContent.content}</p>
            <p className="mb-4 ">{blogContent.content2}</p>
            <p className="mb-4 ">{blogContent.content3}</p>
            <p className="mb-4 ">{blogContent.content4}</p>
            <p className="mb-4 ">{blogContent.content5}</p>
            <p className="mb-4 ">{blogContent.content6}</p>
          </section>
        </article>
      </div>
    </div>
