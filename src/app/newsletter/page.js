...
export default function Newsletter() {
    ...
    <div className="flex flex-wrap xs:justify-center items-top  ">
            ...
            <p className= "my-2 text-white">get exclusive access to</p>
                                <ul role="list" className="space-y-1 my-2 texxt-pretty text-white ">
                                    <li className="flex items-center"><svg className="flex-shrink-0 w-4 h-4 text-blue-700 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
                </svg> <span className="ms-2">Inspiring blog posts.</span></li>
                                    <li className="flex items-center"><svg className="flex-shrink-0 w-4 h-4 text-blue-700 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
                </svg><span className="ms-2"> Stories of impact and success from our projects</span></li>
                                    <li className="flex items-center"><svg className="flex-shrink-0 w-4 h-4 text-blue-700 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
                </svg> <span className="ms-2">Updates on events, workshops, and initiatives.</span></li>
                                </ul>
              ...
              <p className="my-2 text-white text-pretty">Missed a newsletter or want to revisit an inspiring story? Explore our Blog Archive : your gateway to all past allyours updates.</p>
                </div>

                <div className="p-4 pt-4 max-w-sm mt-6 ">
             <h5 className="xs:text-center text-xl font-semibold tracking-tight text-gray-900 dark:text-white">🔔 Subscription </h5>
            <p className="my-2 font-semibold text-white text-pretty underline">Sign up to stay connected</p>
                   </div>
