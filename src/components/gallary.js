    ...
    <section className="">
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-6 lg:px-6">
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
                <Image className="w-full rounded-lg" src="/nwayoo.JPG" alt="nwayoo"  width={150}  height={100}/>
                <Image className="mt-4 w-full lg:mt-10 rounded-lg" src="/nwayoo2.JPG" alt="nwayoo"  width={150}  height={100}/>
            </div>
        </div>
    </section>
  ...
  <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-6 lg:px-6">
    ...
    <section className="">
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-6 lg:px-6">
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
                <Image className="w-full rounded-lg" src="/nwayhtway2.JPG" alt="nwayhtway"  width={150}  height={100}/>
                <Image className="mt-4 w-full lg:mt-10 rounded-lg" src="/nwayhtway.png" alt="nwayhtway"  width={150}  height={100}/>
            </div>
        </div>
    </section>
</>
