          ...
          {services.map((service) => (
            ...
            >
              ...
              <div
                ...
                {/* Front Text */}
                <div className="absolute inset-0 flex items-center justify-center rounded-xl text-center">
                    <p className="text-lg font-semibold text-white brightness-200">{service.title}</p>
                </div>
                {/* Back face */}
